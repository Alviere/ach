...
```
$ kubectl exec -n apps achfuzz-6bbdc574f5-pl2zm -- ls -la /go/src/github.com/Alviere/ach/test/fuzz-reader/crashers/
total 28
...
$ kubectl cp 'apps/achfuzz-6bbdc574f5-pl2zm:/go/src/github.com/Alviere/ach/test/fuzz-reader/crashers/<file>' ./
```
